                    ...
                    <Row>
                        ...
                        <Col xl="6" md="6" sm="12">
                            <div className="payment-card-bottom">
                                <ul>
                                    <li>
                                        <a href="#"><Media src={visa} alt="visa" /></a>
                                    </li>
                                    <li>
                                        <a href="#"><Media src={mastercard} alt="mastercard" /></a>
                                    </li>
                                    <li>
                                        <a href="#"><Media src={paypal} alt="paypal" /></a>
                                    </li>
                                    <li>
                                        <a href="#"><Media src={americanexpress} alt="americanexpress" /></a>
                                    </li>
                                    <li>
                                        <a href="#"><Media src={discover} alt="discover" /></a>
                                    </li>
                                </ul>
                            </div>
                        </Col>
