                                                        ...
                                                        <div className="media img-wrapper">
                                                            <div className="front">
                                                                <a href={'#'}>
                                                                    <Media src={product.images[0].src}
                                                                        className="img-fluid blur-up lazyload" alt={product.title} /></a>
                                                            </div>
                                                            <div className="back">
                                                                <a href={'#'} onClick={() => clickProductDetail(product)}><Media
                                                            ...
                                                            <div className="media-body align-self-center">
                                                                ...
                                                                <div className="cart-bottom">
                                                                    ...
                                                                    <a href={'#'} title="Add to Wishlist" onClick={() => wishlistContext.addToWish(product)}><i
                                                                        className="fa fa-heart" aria-hidden="true"></i></a>
                                                                    <a href={'#'} data-toggle="modal" data-target="#quick-view" onClick={toggle}
                                                                        title="Quick View"><i className="fa fa-plus-circle"
                                                                            aria-hidden="true"></i></a>
                                                                    <a href={'#'} title="Compare" onClick={toggleCompare}><i className="fa fa-refresh"
                                                                        aria-hidden="true"></i></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                            ...
                                                                            <Col lg="12">
                                                                                <div className="media">
                                                                                    <Media src={`${product.variants ?
                                                                                        ...
                                                                                        : product.images[0].src
                                                                                        }`} alt={product.title} className="img-fluid" />
                                                                                    <div className="media-body align-self-center text-center">
                                                                                        ...
                                                                                        <div className="buttons d-flex justify-content-center">
                                                                                            <Link href="/page/compare">
                                                                                                <a href={'#'} className="btn-sm btn-solid" onClick={() => compareContext.addToCompare(product)}>
                                                                                                    View Compare list
                                                                                                </a>
                                                                                            </Link>
                                                                                        </div>
